...
## FK Deletion Order
When deleting from `pages`, delete dependents first: callouts → properties → pages. Use `PRAGMA foreign_keys = OFF` temporarily for pages self-referential parent_id.
